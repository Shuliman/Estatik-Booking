...
?>
    ...
    <input type="text" id="start_date" name="start_date" value="<?php echo esc_attr($start_date); ?>" class="widefat datepicker">

    <label for="end_date"><?php _e('End Date', 'textdomain'); ?></label>
    <input type="text" id="end_date" name="end_date" value="<?php echo esc_attr($end_date); ?>" class="widefat datepicker">
